	...
	return (
		<>
			...
			<Row>
				...
				>
					<div className="pt-5 pt-lg-0 mt-5 mt-lg-0 w-75">
						...
						<p className="text-center text-lg-end">
							...
							lifestyles and human nature
						</p>
						<div className="w-100">
							<Button
								variant="outline-dark"
								size="lg"
								className="float-lg-end rounded-pill px-5"
							>
								Buy
							</Button>
						</div>
				...
				<Col lg={6} className="p-0 order-2">
					<Image
						fluid
				...
				>
					<div className="d-flex flex-column w-50 mx-5">
						...
						<p className="text-start fw-light">
							Prado consists of a vast bench seat (available in two sizes:
